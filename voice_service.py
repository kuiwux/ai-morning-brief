...
EDGE_VOICE_MAP = {
    # 中文语音
    "edge_yunxi":    {"voice": "zh-CN-YunxiNeural",     "name": "云希（男播音员）", "emoji": "🧑", "style": "沉稳大气", "lang": "zh"},
    "edge_xiaoxiao": {"voice": "zh-CN-XiaoxiaoNeural",  "name": "晓晓（女播音员）", "emoji": "👩", "style": "温柔清晰", "lang": "zh"},
    "edge_yunjian":  {"voice": "zh-CN-YunjianNeural",   "name": "云健（电影解说）", "emoji": "🎬", "style": "戏谑幽默", "lang": "zh"},
    "edge_yunyang":  {"voice": "zh-CN-YunyangNeural",   "name": "云扬（技术极客）", "emoji": "🤖", "style": "快速理性", "lang": "zh"},
    # 英文语音
    "en_us_aria":    {"voice": "en-US-AriaNeural",      "name": "Aria（美式女声）",     "emoji": "🗽", "style": "清晰自然", "lang": "en"},
    "en_us_guy":     {"voice": "en-US-GuyNeural",       "name": "Guy（美式男声）",      "emoji": "🎙️", "style": "沉稳专业", "lang": "en"},
    "en_us_jenny":   {"voice": "en-US-JennyNeural",     "name": "Jenny（新闻主播）",    "emoji": "📰", "style": "新闻风格", "lang": "en"},
    "en_gb_ryan":    {"voice": "en-GB-RyanNeural",      "name": "Ryan（英式男声）",     "emoji": "🇬🇧", "style": "优雅英伦", "lang": "en"},
}
...
class VoiceService:
    ...
    def get_preset_voices(self) -> list[dict]:
        """返回预设语音列表（Edge TTS，中英8预设置）"""
        voices = []
        for voice_id, info in EDGE_VOICE_MAP.items():
            voices.append({
                "id": voice_id,
                "name": info["name"],
                "emoji": info["emoji"],
